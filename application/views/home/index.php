...
<h1>eBay API Setup</h1>
    <!-- main content output -->
    <div>
    <p>Demonstration of [search eBay categories](/home/categories), 
    [get item aspects](/home/specifics), and [OAuth tokens](/home/tokens).
    Use these examples to implement other API calls.</p>
